import os
import time
from funcs.data_fitting import *
from funcs.utils.error_metrics import *
...
def run_dataset(folder, data_name, n_data, y_vars, X_vars_dict, n_intervals_dict, bdegs_dict,
    ...
    ## reading data
    path_read_data = os.path.join(os.getcwd(), 'shape_constrained_smooth_additive_regression_model','data', folder)
